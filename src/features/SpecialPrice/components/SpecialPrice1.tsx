...
import Sprice1 from "@/assets/image/sprice.png";
...
const SpecialPrice1 = () => {
  return (
    <div className="w-full h-full relative overflow-hidden shadow-lg rounded-lg group cursor-pointer transform transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl">
      <Image
        className="absolute w-full transition-transform duration-700 group-hover:scale-110"
        src={Sprice1}
        alt="ayam"
      />
